<template>
	<div>
			...
			<div class="head-main">
				<div class="head-title">
					<div class="head-title-icon">
						<img src="~/assets/img/personalArea/icon4-red.png" alt="" />
					</div>
					<div class="head-title-content">
						<h1>Анализы</h1>
						<p>Просматривайте свои готовые анализы и их историю</p>
					</div>
					<p class="mobile">Просматривайте свои готовые анализы и их историю</p>
				</div>
				<button class="add-froze btn-add-analysis">
					Добавить анализ
		...
		<!-- END HEAD -->
		<!-- MAIN -->
		<section class="analysis col-main diary-main">
			<h2>Мои анализы</h2>
			<div class="details">
				<div class="details-item">
					<div class="details-item-main">
						...
						<div class="col-item">
							<p class="subtitle">Дата забора анализа</p>
							<h3 class="title">12.06.2022, 15:33</h3>
						</div>
						<div class="btn-square-group">
							<a href="#modal-1" class="btn-square-blue btn-show-item">Посмотреть</a>
				...
				<div class="details-item">
					<div class="details-item-main">
						...
						<div class="btn-square-group">
							<a href="#modal-2" class="btn-square-blue btn-show-item">Посмотреть</a>
							<button class="btn-square-transparent open-share-modal">
								Поделиться
								<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path d="M8.0625 5.4375L12 1.5L15.9375 5.4375" stroke="#4065AE" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
				...
				<div class="details-item">
					<div class="details-item-main">
						...
						<div class="btn-square-group">
							<a href="#modal-3" class="btn-square-blue btn-show-item">Посмотреть</a>
							<button class="btn-square-transparent open-share-modal">
								Поделиться
								<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path d="M8.0625 5.4375L12 1.5L15.9375 5.4375" stroke="#4065AE" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
				...
				<div class="details-item">
					<div class="details-item-main">
						...
						<div class="btn-square-group">
							<a href="#modal-4" class="btn-square-blue btn-show-item">Посмотреть</a>
							<button class="btn-square-transparent open-share-modal">
								Поделиться
								<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path d="M8.0625 5.4375L12 1.5L15.9375 5.4375" stroke="#4065AE" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
				...
				<div class="hidden-details hidden">
					<div class="details-item">
						<div class="details-item-main">
							...
							<div class="btn-square-group">
								<a href="~/assets/img/personalArea/test-zhurek.pdf" target="_blank" class="btn-square-blue">Посмотреть</a>
								<button class="btn-square-transparent open-share-modal">
									Поделиться
									<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M8.0625 5.4375L12 1.5L15.9375 5.4375" stroke="#4065AE" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
